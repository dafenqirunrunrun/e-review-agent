...
ARTIFACT = ROOT / "artifacts" / "retrieval-optimization" / "v23-phase-95a-qc-gate.json"


def main() -> int:
    payload = json.loads(ARTIFACT.read_text(encoding="utf-8"))
    if payload.get("decision") == "E_REVIEW_V23_PHASE_95A_QC_PASS":
        print("E_REVIEW_V23_PHASE_95A_QC_PASS")
        ...
        return 0
    print("E_REVIEW_V23_PHASE_95A_QC_BLOCKED")
