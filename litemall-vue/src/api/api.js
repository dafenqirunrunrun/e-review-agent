...
const OrderMockPay='/ai-demo/order/mock-pay'; // AI demo payment
export function orderMockPay(data) {
  return request({
    url: OrderMockPay,
    method: 'post',
    data
...
const OrderMockShip='/ai-demo/order/mock-ship'; // AI demo shipping
export function orderMockShip(data) {
  return request({
    url: OrderMockShip,
    method: 'post',
    data
...
const AiDemoStatus='/ai-demo/status'; // AI demo mode status
export function aiDemoStatus() {
  return request({
    url: AiDemoStatus,
    method: 'get'
  })
