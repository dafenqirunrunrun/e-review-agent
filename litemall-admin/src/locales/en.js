...
export default {
  ...
  app: {
    menu: {
      ...
      review_governance_center: 'Review governance',
      review_console: 'Review console',
      manual_review_hitl: 'Manual review',
      evidence_library: 'Evidence library',
      auto_review_records: 'Auto review records',
      ai_workbench_home: 'Governance home',
      ai_agentic_demo: 'Agentic workflow demo',
      ai_governance_flow: 'Review governance flow',
      ai_observability: 'Observability and eval',
      ai_knowledge_quality: 'Knowledge and quality',
      ai_platform_governance: 'Platform governance',
      ai_dashboard: 'Overview',
      ai_review: 'AI Review',
      ai_review_analyze: 'Review analysis',
      ai_demo_review: 'Demo review submit',
      ai_risk: 'Risk center',
      ai_patrol: 'Agent patrol',
      ai_agent_trace: 'Agent trace',
      ai_agent_eval: 'Agent eval',
      ai_agentops: 'AgentOps',
      ai_operation: 'Operation center',
      ai_history: 'Analysis history',
      ai_case_knowledge: 'Case knowledge',
      ai_memory_center: 'Memory center',
      ai_tool_registry: 'Tool registry',
      ai_guardrails: 'Guardrails',
      ai_agent_registry: 'Agent registry',
      ai_rag_quality: 'RAG quality',
      ai_config: 'System config',
      agent_rag: 'Agent-RAG Operations',
      agent_rag_overview: 'Overview',
      agent_rag_runs: 'Analysis runs',
      agent_rag_detail: 'Run details',
      agent_rag_runtime: 'Runtime status',
      agent_rag_security: 'Security governance',
  ...
  ai_review: {
    ...
    message: {
      empty: 'Fill in the review form and start analysis',
      success_title: 'Success',
      success: 'AI review analysis finished',
      fail_title: 'Failed',
      fail: 'AI review analysis failed'
    },
    validate: {
      product_id: 'Goods ID is required',
      product_name: 'Goods name is required',
      review_text: 'Review content is required'
    },
    result: {
      review_id: 'Review ID',
