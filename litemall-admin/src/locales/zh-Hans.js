...
export default {
  ...
  app: {
    menu: {
      ...
      stat_goods: '商品统计',
      ai_workbench: 'AI 工作台',
      review_governance_center: '评论治理中心',
      review_console: '审核工作台',
      manual_review_hitl: '人工复核',
      evidence_library: '判定依据库',
      auto_review_records: '自动审核记录',
      ai_workbench_home: '智能治理首页',
      ai_agentic_demo: 'Agentic 工作流 Demo',
      ai_governance_flow: '评论治理流程',
      ai_observability: '运行观测与评估',
      ai_knowledge_quality: '知识增强与质量',
      ai_platform_governance: '平台治理设置',
      ai_dashboard: 'AI 工作台总览',
      ai_review: '评价分析',
      ai_review_analyze: '评价分析',
      ai_demo_review: '模拟评论提交',
      ai_risk: '风险评论中心',
      ai_patrol: '智能体巡检',
      ai_agent_trace: '执行追踪',
      ai_agent_eval: '评估中心',
      ...
      ai_operation: '运营处理中心',
      ai_history: '分析历史记录',
      ai_case_knowledge: '案例知识库',
      ai_memory_center: '记忆中心',
      ai_tool_registry: '工具注册中心',
      ai_guardrails: '安全护栏',
      ai_agent_registry: '智能体注册中心',
      ai_rag_quality: 'RAG 质量评估',
      ai_config: '配置中心',
      agent_rag: 'Agent-RAG 运行中心',
      agent_rag_overview: '运行概览',
      agent_rag_runs: '分析记录',
      agent_rag_detail: '运行详情',
      agent_rag_runtime: '运行状态',
      agent_rag_security: '安全治理',
      external_link: '外链',
