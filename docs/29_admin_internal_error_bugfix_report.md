# 29 Admin Internal Error Bugfix Report
...
Do not fabricate test results. Use current command output as evidence. Important markers include DEMO_PRODUCT_SEED_PASS, ADMIN_FULL_MENU_API_PASS, ADMIN_API_MATRIX_PASS, DOC_LINK_CHECK_PASS, ENCODING_CHECK_PASS, AGENT_QUALITY_CHECK_PASS, FULL_UI_FLOW_PASS, CUSTOMER_ADMIN_END_TO_END_PASS, and FINAL_ACCEPTANCE_PASS.
