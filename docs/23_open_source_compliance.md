...
Keep LICENSE, NOTICE.md, THIRD_PARTY_LICENSES.md, and this compliance document. Defense materials may focus on E-Review Agent capabilities, while repository compliance files continue to describe open-source origins and license obligations.
